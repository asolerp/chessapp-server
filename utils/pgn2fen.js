// LT-PGN-VIEWER 3.493 (c) Lutz Tautenhahn (2001-2012)
...
{ isAutoPlay=bb;
  ...
  { if ((document.BoardForm)&&(document.BoardForm.AutoPlay))
      document.BoardForm.AutoPlay.value="Auto";
  }
}
...
{ SetBoardClicked(-1);
  ...
  { Init('standard');
    ...
    if ((document.BoardForm)&&(document.BoardForm.SetupBoard))
      document.BoardForm.SetupBoard.value="Create FEN";
    return;
  }
  isSetupBoard=false;
  if ((document.BoardForm)&&(document.BoardForm.SetupBoard))
...
module.exports = {
  Init, SetPgnMoveText, MoveForward, GetFEN
}